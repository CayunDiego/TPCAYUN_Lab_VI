<%-- 
    ...
    Created on : 07/11/2019, 19:06:58
    Author     : Diego
--%>
<%
...
<!-------------------------------------------HOME---------------------------------------------------->      
    <div id="home">
            ...
            <div class="principal ">
                ...
                <div class="secundarioCliente table-wrapper-scroll-y my-custom-scrollbar2">
                    <h1>AGREGAR CATALOGO</h1>
                                ...
                                <tbody>
                                    <c:forEach items="${listaA}" var="c" >  
                                        <tr>
                                          ...
                                          <td><a href="/TPCAYUN/agregarCatalogoServlet?id=${c.getIdArticulo()}"><button type="button" class="btn btn-info">PUBLICAR</button></a></td>
                                        </tr>
                                    </c:forEach>  
                                </tbody>
                            </table>   
                        ...
                        <div>
                            <form method="POST" action="/TPCAYUN/agregarCatalogoServlet" >
                                            ...
                                            <tr>
                                                <c:forEach items="${listaProvi}" var="c" > 
                                                  <td>
                                                      ...
                                                      <p>STOCK ${c.getStock()}</p>
                                                      <input hidden="" type="number" name="txtId${c.getIdArticulo()}" value="" class="form-control" id="txtId${c.getIdArticulo()}">


                                                      <a href="/TPCAYUN/agregarCatalogoServlet?ideEliminar=${c.getIdArticulo()}"><button type="button" class="btn btn-outline-danger">ELIMINAR</button></a>
                                                  </td>
                                                </c:forEach>  
                                            </tr>
                                        </tbody>
            ...
            <div class="form-group">
                ...
                <input type="date" id="start" name="txtFecha1"
                       
                       min="2018-01-01" max="2300-12-31" >
            </div>   
            ...
            <button type="submit" onclick="validarAltaVenta()" class="btn btn-primary">AGREGAR CATALOGO</button>
                            </form>
                        </div>
                </div>
            </div>
