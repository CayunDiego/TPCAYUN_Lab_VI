<%-- 
    ...
    Created on : 30/10/2019, 23:11:46
    Author     : Diego
--%>
<%
            ...
            <tbody>
                <c:forEach items="${listaC}" var="c">      
                    <tr>
                      ...
                      <td>${c.getTelefono()}</td>
                      <td>${c.getSaldo()}</td>
                      <td><a href="/TPCAYUN/eliminarClienteServlet?id=${c.getIdCliente()}"><button type="button" class="btn btn-outline-danger">ELIMINAR</button></a></td>
                      <td><a href="/TPCAYUN/agregarCliente?id=${c.getIdCliente()}"><button type="button" class="btn btn-info">EDITAR</button></a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
