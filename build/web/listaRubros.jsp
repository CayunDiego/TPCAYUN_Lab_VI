<%-- 
    Document   : listaRubros
    Created on : 02/11/2019, 18:21:20
    Author     : Diego
--%>
<%
            ...
            <div class="container">
                ...
                <ul class="main-nav nav navbar-nav navbar-right tamañoMenu">
                    ...
                    <li class="has-dropdown"><a href="">Articulos</a>
                     ...
                     <li class="has-dropdown active"><a href="">Rubro</a>
                        <ul class="dropdown">
                        ...
                        <table class="table table-hover table-dark">
                            ...
                            <tbody>
                                <c:forEach items="${listaR}" var="c">
                                    <tr>
                                      <th scope="row">${c.getIdRubro()}</th>
                                      <td>${c.getNombre()}</td>
                                       <td><a href="/TPCAYUN/eliminarRubroServlet?id=${c.getIdRubro()}"><button type="button" class="btn btn-outline-danger">ELIMINAR</button></a></td>
                                        <td><a href="/TPCAYUN/agregarRubroServlet?id=${c.getIdRubro()}"><button type="button" class="btn btn-info">EDITAR</button></a></td>
                                    </tr>
                                </c:forEach> 
                            </tbody>
                        </table>
