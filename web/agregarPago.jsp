<%-- 
    ...
    Created on : 03/11/2019, 04:59:05
    Author     : Diego
--%>
<%
    ...
    <div id="home">
            ...
            <div class="principal ">
                ...
                <div class="secundarioCliente table-wrapper-scroll-y my-custom-scrollbar2">
                    ...
                    <h1>Agregar Pago de ${client.getNombre()} ${client.getApellido()}</h1>

                    <h3>DEUDA: ${client.getSaldo()}</h3>
                    <form method="POST" action="/TPCAYUN/agregarPagoServlet">
                        <input hidden="" type="number" name="txtId" value="${id}" class="form-control" id="txtId">
                        <div class="form-group">
                          <label for="txtPago">MONTO PAGO</label>
                          <input type="number" name="txtPago" value="${saldo}" class="form-control" id="txtPago" placeholder="Ingrese Pago menor o igual a su deuda">
                        </div>
