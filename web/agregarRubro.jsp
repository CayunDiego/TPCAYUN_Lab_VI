<%-- 
    Document   : agregarRubro
    Created on : 02/11/2019, 18:44:58
    Author     : Diego
--%>
<%
            ...
            <div class="principal ">
                ...
                <div class="secundarioCliente table-wrapper-scroll-y my-custom-scrollbar2">
                    ...
                    <h1>Agregar Rubro</h1>
                        ...
                        <form method="POST" action="/TPCAYUN/agregarRubroServlet">
                            <input hidden="" type="number" name="txtId" value="${id}" class="form-control" id="txtId">
                            <div class="form-group">
                              <label for="txtNombre">RUBRO</label>
                              <input type="text" name="txtNombre" value="${nombre}" class="form-control" id="txtNombre" placeholder="Ingrese Rubro" required="">
                            </div>

                            <button type="submit" onclick="validarAltaRubro()" class="btn btn-primary">AGREGAR</button>
