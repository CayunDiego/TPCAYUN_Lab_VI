<%-- 
    Document   : index
    Created on : 30/10/2019, 22:20:18
    Author     : Diego
--%>
                        ...
                        <div class="indx">
                            <div >
                                <div class="home-content">
                                    <h2 class="white-text">ADMINISTRACIÓN DE CUENTAS CORRIENTE</h2>
                                    <p class="white-text">
                                        Trabajo Práctico Final
                                    </p>
                                    <p class="white-text">
                                        Laboratorio IV - Diseño y Administración de Base de Datos
                                    </p>
                                    <p class="white-text">
                                        CAYUN GARCIA, Diego Saul
                                    </p>
                                    <a href="/TPCAYUN/listaCatalogoServlet"> <button class="white-btn">Catalogo</button></a>
                                    <a href="/TPCAYUN/login.jsp"> <button class="main-btn" >Sign in</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
