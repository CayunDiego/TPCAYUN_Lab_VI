<%-- 
    ...
    Created on : 01/11/2019, 00:35:49
    Author     : Diego
--%>
<%
                ...
                <div class="secundarioCliente table-wrapper-scroll-y my-custom-scrollbar2">
                         <h1>Listado de articulos</h1>
                            ...
                            <table class="table table-hover table-dark">
                                ...
                                <tbody>
                                    <c:forEach items="${listaArticulo}" var="c" >  
                                        <tr>
                                          <th scope="row">${c.getIdArticulo()}</th>
                                          <td>${c.getNombre()}</td>
                                          <td>${c.getPrecio()}</td>
                                          <td>${c.getStock()}</td>
                                          <td><img class="img-thumbnail" style="width:80px; height:auto;" src="Assets/Images/${c.getImagen()}"></td>
                                          <td>${c.getRubro().getNombre()}</td>
                                          <td><a href="/TPCAYUN/eliminarArticuloServlet?id=${c.getIdArticulo()}"><button type="button" class="btn btn-outline-danger">ELIMINAR</button></a></td>
                                          <td><a href="/TPCAYUN/agregarArticuloServlet?id=${c.getIdArticulo()}"><button type="button" class="btn btn-info">EDITAR</button></a></td>
                                        </tr>
                                    </c:forEach>  
                                </tbody>
                            </table>
