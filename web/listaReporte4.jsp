<%-- 
    Document   : listaReporte4
    Created on : 09/11/2019, 07:45:28
    Author     : Diego
--%>
<%
                        ...
                        <table class="table table-hover table-dark">
                            <thead>
                              <tr>
                                ...
                                <th scope="col">CANT DE VECES VENDIDO</th>
                                <th scope="col">CANT DE UNIDADES VENDIDO</th>
                            ...
                            <tbody>
                                <c:forEach items="${listaR}" var="c">      
                                    <tr>
                                      ...
                                      <td>${c.getNomArticulo()}</td>
                                      <td>${c.getCantVeces()}</td>
                                      <td>${c.getCantVend()}</td>
                                      <td>${c.getCantClient()}</td>
