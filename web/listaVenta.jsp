<%-- 
    Document   : listaVenta
    Created on : 06/11/2019, 02:13:26
    Author     : Diego
--%>
<%
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${c.getDetalles()}" var="d">
                                        <tr>
                                          ...
                                          <td></td>
                                          <td>Cantidad: ${d.getCantidad()}</td>
                                          <td>Precio Unitario: ${d.getPrecioUnitario()}</td>
                                          <td>Sub Total: ${d.getPrecioUnitario()*d.getCantidad()} </td>
                                        </tr>
                                    </c:forEach> 
                                    <tr>
                                        <td></td>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td>MONTO TOTAL: ${c.getMontoTotal()}</td>
                                    </tr>
                                </tbody>
                            </table>
                            <hr>
