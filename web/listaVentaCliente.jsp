<%-- 
    Document   : listaVentaCliente
    Created on : 06/11/2019, 04:25:19
    Author     : Diego
--%>
<%
    ...
    <div id="home">
            ...
            <div class="principal ">
                ...
                <div class="secundarioCliente table-wrapper-scroll-y my-custom-scrollbar2">
                    ...
                    <h1>LISTA VENTA CLIENTE</h1>
        
                    <div>
                        <form method="POST" action="/TPCAYUN/listaVentasClienteServlet" >  
                    ...
                    <div>
                        <c:forEach items="${listaV}" var="e">
                            <table class="table table-hover table-dark">
                                ...
                                <tbody>
                                    <tr>
                                         <th scope="row">${e.getIdVenta()}</th>
                                         <td>${e.getIdVenta()}</td>
                                         <td>${e.getCliente().getNombre()} ${e.getCliente().getApellido()}</td>
                                    </tr>
                                    <tr>
                                         <td>DETALLE VENTA</td>
                                    </tr>
                                    <c:forEach items="${e.getDetalles()}" var="f">
                                        <tr>
                                          <th scope="row"><img class="img-thumbnail" style="width:50px; height:auto;" src="Assets/Images/${f.getArticulo().getImagen()}">${f.getArticulo().getNombre()}</th>
                                          <td></td>
                                          <td>Cantidad: ${f.getCantidad()}</td>
                                          <td>Precio Unitario: ${f.getPrecioUnitario()}</td>
                                          <td>Sub Total: ${f.getPrecioUnitario()*f.getCantidad()} </td>
                                        </tr>
                                    </c:forEach> 
                                    <tr>
                                        <td></td>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td>MONTO TOTAL: ${e.getMontoTotal()}</td>
