<%-- 
    Document   : modificacionImporte
    Created on : 08/11/2019, 08:20:32
    Author     : Diego
--%>
<%
            ...
            <div class="principal ">
                ...
                <div class="secundarioCliente table-wrapper-scroll-y my-custom-scrollbar2">
                         <h1>LISTADO DE CLIENTES</h1>
                            ...
                            <form method="POST" action="/TPCAYUN/modificacionImporteServlet">
                                <h3>Porcentaje de interes a aplicar (0.0): </h3>

                                <input type="number" required name="txtInteres"  class="form-control" min="0"  step=".01" id="txtInteres" placeholder="0.0" value="${txtInteres}">
                                ...
                                <table class="table table-hover table-dark">
                                   ...
                                   <!--     <th scope="col"><a href="/TPCAYUN/modificacionImporteServlet?todos=true&&por=<script>myFunction()</script>"><button type="button" class="btn btn-outline-success">APLICAR A TODOS</button></a></th>
                                    -->
                                      </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach items="${listaC}" var="c">      
                                            <tr>
                                              ...
                                              <td>${c.getSaldo()}</td>
                                              <td>Aplicar?
                                                  <input type="checkbox" name="aplicarImp" value="${c.getIdCliente()}">
                                              </td>
                                            ...
                                            <tr class="bg-success">
                                              ...
                                              <td></td>
                                              <td >TODOS ?
                                                  <input type="checkbox" name="aplicarImp" value="0">
                                              </td>
